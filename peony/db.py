...
def download_gee_image(geojson_path, output_path, image, max_tile_size=8):
    import geedim as gd
    gd.Initialize()
    ...
    im.download(os.path.join(output_path, Path(geojson_path).stem + ".tif"), region=polygon, max_tile_size=max_tile_size)
